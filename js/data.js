...
const MISSION_TEMPLATES = [
  ...
  { id: 'rhythm_hit_finish', text: '리듬 히트 {n}회 완료', icon: '🎵', type: 'generated', category: 'rhythm-hit', counts: [1, 2, 3] },
];
...
const BRAIN_DEVELOPMENT_LIBRARY = [
  {
    ...
    icon: '🧠',
    title: '언어 패턴 놀이',
    description: '소리와 글자를 연결하며 언어 작업기억을 키워요.',
  ...
  },
  {
    ...
    icon: '👀',
    title: '시각 집중 훈련',
    description: '짧은 시각 기억 놀이로 집중력과 회상 속도를 높여요.',
    focus: 'visual-memory',
  ...
  },
  {
    ...
    icon: '🏗️',
    title: '논리 타워 챌린지',
    description: '단계별 문제를 풀며 즉시 피드백으로 사고력을 키워요.',
    focus: 'logic',
    ageGroups: ['child', 'older'],
  ...
  },
  {
    ...
    icon: '🎯',
    title: '집행 기능 훈련',
    description: '규칙 전환과 억제 조절 놀이로 인지 유연성을 길러요.',
  ...
  },
  {
    ...
    icon: '🧩',
    title: '공간 추론 연구소',
    description: '패턴 블록과 짝맞추기로 공간 지각 능력을 높여요.',
    focus: 'spatial',
    ageGroups: ['toddler', 'child', 'older'],
  ...
  },
  {
    ...
    icon: '🎨',
    title: '창의 집중 스튜디오',
    description: '차분한 색칠 놀이로 집중 지속력과 감정 조절을 도와요.',
...
// Badge definitions
const BADGES = [
  { id: 'hangul-stage1', name: '한글 시작', emoji: 'H1', condition: 'hangul_s1', description: '한글 1단계를 완료했어요' },
  { id: 'hangul-stage2', name: '한글 새싹', emoji: 'H2', condition: 'hangul_s2', description: '한글 2단계를 완료했어요' },
  { id: 'hangul-master', name: '한글 마스터', emoji: 'HM', condition: 'hangul_s3', description: '한글 마지막 단계를 완료했어요' },
  { id: 'english-stage1', name: '영어 시작', emoji: 'E1', condition: 'english_s1', description: '영어 1단계를 완료했어요' },
  { id: 'english-master', name: '영어 챔피언', emoji: 'EM', condition: 'english_s3', description: '영어 마지막 단계를 완료했어요' },
  { id: 'number-master', name: '숫자 마스터', emoji: 'NM', condition: 'number_s3', description: '숫자 마지막 단계를 완료했어요' },
  { id: 'math-master', name: '수학 히어로', emoji: 'MH', condition: 'math_s3', description: '수학 마지막 단계를 완료했어요' },
  { id: 'quiz-beginner', name: '퀴즈 시작', emoji: 'Q1', condition: 'quiz_10', description: '퀴즈 정답 10개 달성' },
  { id: 'quiz-king', name: '퀴즈 왕', emoji: 'QK', condition: 'quiz_50', description: '퀴즈 정답 50개 달성' },
  { id: 'matching-star', name: '짝맞추기 스타', emoji: 'M*', condition: 'matching_10', description: '짝맞추기 10판 완료' },
  { id: 'sound-finder', name: '소리 탐험가', emoji: 'SF', condition: 'sound_10', description: '소리찾기 정답 10개 달성' },
  { id: 'tracing-star', name: '따라쓰기 스타', emoji: 'TS', condition: 'tracing_10', description: '따라쓰기 10회 완료' },
  { id: 'tower-rookie', name: '타워 루키', emoji: 'TR', condition: 'tower_3', description: '타워 놀이 3회 달성' },
  { id: 'tower-architect', name: '타워 건축가', emoji: 'TA', condition: 'tower_10', description: '타워 놀이 10회 달성' },
  { id: 'tower-skyline', name: '스카이라인 빌더', emoji: 'SB', condition: 'tower_best_8', description: '타워 8층 도달' },
  { id: 'streak-3', name: '3일 연속', emoji: 'S3', condition: 'streak_3', description: '학습 3일 연속 달성' },
  { id: 'streak-7', name: '7일 연속', emoji: 'S7', condition: 'streak_7', description: '학습 7일 연속 달성' },
  { id: 'streak-14', name: '14일 연속', emoji: 'S14', condition: 'streak_14', description: '학습 14일 연속 달성' },
  { id: 'streak-30', name: '30일 연속', emoji: 'S30', condition: 'streak_30', description: '학습 30일 연속 달성' },
  { id: 'star-collector', name: '별 수집가', emoji: 'SC', condition: 'stars_50', description: '별 50개 모으기' },
  { id: 'star-master', name: '별 마스터', emoji: 'SM', condition: 'stars_200', description: '별 200개 모으기' },
  { id: 'sticker-lover', name: '스티커 러버', emoji: 'SL', condition: 'stickers_15', description: '스티커 15개 모으기' },
  { id: 'level-5', name: '레벨 5', emoji: 'L5', condition: 'level_5', description: '레벨 5 달성' },
  { id: 'level-10', name: '레벨 10', emoji: 'L10', condition: 'level_10', description: '레벨 10 달성' },
  { id: 'all-rounder', name: '올라운더', emoji: 'AR', condition: 'all_stages', description: '모든 단계를 완료했어요' },
];
